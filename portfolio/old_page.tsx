...
const projects = [
  {
    title: 'EcoShift ΓÇô A Carbon Footprint Tracker App',
            ...
            >
              ...
              >
                <h3 className="text-2xl font-bold mb-8 flex items-center gap-3">
                  <span className="text-purple-400">≡ƒ¢á∩╕Å</span>
                  <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Skills</span>
                </h3>
                <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                  {[
                    { name: 'Python (Intermediate)', icon: '≡ƒÉì' },
                    { name: 'C/C++ (Intermediate)', icon: '≡ƒÆ╗' },
                    { name: 'Java (Basic)', icon: 'Γÿò' },
                    { name: 'HTML & CSS (Intermediate)', icon: '≡ƒîÉ' },
                    { name: 'Machine Learning', icon: '≡ƒñû' },
                    { name: 'Deep Learning', icon: '≡ƒºá' },
                    { name: 'OpenCV', icon: '≡ƒô╖' },
                    { name: 'React.js', icon: 'ΓÜ¢∩╕Å' }
                  ].map((skill) => (
              ...
              >
                <h3 className="text-2xl font-bold mb-8 flex items-center gap-3">
                  <span className="text-purple-400">≡ƒÄô</span>
                  <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Education</span>
                </h3>
                <div className="space-y-8">
                  {[
                    { title: 'Master of Computer Applications (MCA)', school: 'IIT Patna & IIIT Ranchi', detail: 'August 2025 ΓÇô Present (Expected: July 2027)' },
                    { title: 'Bachelor of Computer Applications (BCA)', school: 'Amity University Jharkhand', detail: 'July 2021 ΓÇô June 2024' },
              ...
              >
                <h3 className="text-2xl font-bold mb-8 flex items-center gap-3">
                  <span className="text-purple-400">≡ƒô£</span>
