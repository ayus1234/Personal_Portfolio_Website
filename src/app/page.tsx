  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background text-foreground transition-colors duration-300">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
          ...
          <motion.div
            ...
            className="absolute top-[40%] -right-[10%] w-[35%] h-[35%] bg-blue-600/10 blur-[120px] rounded-full"
          />
          <motion.div
            animate={{
              x: [0, 50, 0],
            ...
            className="absolute -bottom-[10%] left-[20%] w-[30%] h-[30%] bg-pink-600/5 blur-[120px] rounded-full"
          />
        </div>
        ...
        >
          ...
          <div className="absolute inset-0 z-0 pointer-events-none">
            ...
            <div className="absolute top-[10%] right-[5%] w-[500px] h-[500px] bg-primary-from/5 blur-[120px] rounded-full" />
          </div>

          <div className="container scroll-mt-24 mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              {/* Left Content */}
              <div className="flex flex-col items-start text-left order-2 lg:order-1 lg:pr-8">
                <motion.p
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: 0.2 }}
                  className="text-primary-from font-medium tracking-widest text-lg mb-4 uppercase"
                >
                  HI, I AM
                </motion.p>
                <motion.h1
                  ...
                  className="text-5xl sm:text-6xl md:text-7xl font-bold mb-4 text-foreground"
                >
                ...
                <motion.div
                  ...
                  className="text-2xl sm:text-3xl font-bold mb-6 flex items-center text-foreground/90"
                >
                ...
                <motion.p
                  ...
                  className="text-muted text-lg sm:text-xl max-w-xl mb-10 leading-relaxed"
                >
                ...
                >
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-3 bg-gradient-to-r from-primary-from to-primary-to text-white rounded-full text-base font-semibold shadow-lg shadow-primary-from/10 hover:shadow-primary-from/25 transition-all duration-300 relative overflow-hidden group"
                  >
                  ...
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-3 border border-card-border text-foreground rounded-full text-base font-semibold hover:bg-card transition-all duration-300"
                  >
                    Contact Me
                  </motion.a>
                </motion.div>
              ...
              <motion.div
                ...
                className="order-1 lg:order-2 flex justify-center lg:justify-end perspective-[1000px] w-full"
              >
                <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-[350px] lg:h-[350px] rounded-full overflow-hidden border-[4px] border-card-border shadow-[0_0_40px_rgba(var(--highlight),0.15)] z-10 bg-card flex items-center justify-center">
                  <Image
        ...
        <motion.section
          ...
          className="py-24 relative overflow-hidden bg-subtle-bg border-t border-card-border"
        >
          <div className="container scroll-mt-24 mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-6xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full mb-8">
              {/* About Card */}
              <motion.div
                whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(var(--highlight), 0.1)" }}
                className="bg-card rounded-3xl p-8 sm:p-10 border border-card-border shadow-2xl relative overflow-hidden group hover:border-primary-from/30 transition-colors h-full flex flex-col"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary-from/5 rounded-bl-full pointer-events-none group-hover:bg-primary-from/10 transition-colors" />
                <h3 className="text-2xl font-bold mb-8 flex items-center gap-3 relative z-10">
                  <span className="text-foreground">About Me</span>
                </h3>
                <div className="relative z-10 flex-1">
                  <p className="text-muted leading-relaxed text-sm sm:text-base mb-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <span className="px-4 py-2 bg-primary-from/10 text-primary-from border border-primary-from/20 rounded-xl text-sm font-bold tracking-wide">Developer</span>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(var(--highlight), 0.1)" }}
                className="bg-card rounded-3xl p-8 sm:p-10 border border-card-border shadow-2xl relative overflow-hidden group hover:border-primary-to/30 transition-colors h-full flex flex-col"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary-to/5 rounded-bl-full pointer-events-none group-hover:bg-primary-to/10 transition-colors" />
                <h3 className="text-2xl font-bold mb-8 flex items-center gap-3 relative z-10">
              ...
              >
                ...
                <div className="space-y-8 relative z-10 flex-1">
                  {[
                    ...
                    <div key={edu.title} className="relative pl-6 border-l-2 border-primary-from/30">
                      <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-primary-from shadow-lg shadow-primary-from/50" />
                      <h4 className="text-foreground text-lg font-bold mb-1 leading-snug">{edu.title}</h4>
                      <p className="text-primary-from font-medium mb-1 text-sm">{edu.school}</p>
              ...
              >
                ...
                <div className="space-y-6 relative z-10 flex-1">
                  {[
                    ...
                    <div key={cert.name} className="p-5 bg-subtle-bg rounded-2xl border border-card-border hover:border-primary-to/30 transition-colors">
                      <h4 className="text-foreground text-lg font-bold mb-2 leading-snug">{cert.name}</h4>
                      <p className="text-primary-to font-medium mb-1 text-sm">{cert.issuer}</p>
        ...
        <motion.section
          ...
          className="py-24 relative overflow-hidden bg-subtle-bg border-t border-card-border"
        >
          <div className="container scroll-mt-24 mx-auto px-4 sm:px-6 lg:px-8 max-w-[1400px]">
            <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center text-foreground">
        ...
        <motion.section
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          className="py-24 relative overflow-hidden bg-transparent border-t border-card-border"
        >
          ...
          <div className="container scroll-mt-24 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-start">
                ...
                >
                  {[
                    ...
                    <motion.a
                      ...
                      className="flex items-center justify-between p-4 rounded-2xl bg-card border border-card-border hover:border-primary-from/30 transition-colors group"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <div className="flex items-center gap-4">
                        <div className="w-8 h-8 rounded-full bg-subtle-bg flex items-center justify-center group-hover:bg-primary-from transition-colors">
                          <svg className="w-4 h-4 text-muted group-hover:text-white" fill="currentColor" viewBox="0 0 24 24"><path d={social.icon} /></svg>
                        </div>
              ...
              <div className="flex items-center justify-center lg:justify-end w-full">
                <div className="w-full max-w-lg p-8 sm:p-10 rounded-[2rem] border border-card-border bg-card">
                  <ContactForm />
                </div>
              </div>
            </div>
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-primary-from rounded-full flex items-center justify-center text-white hover:bg-primary-to transition-colors z-50 shadow-[0_0_20px_rgba(var(--highlight),0.4)]"
      >
